...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(TextField, [{
    ...
    value: function render() {
      ...
      var elementClasses = (0, _classnames.default)("".concat(_constants.OLT_NAMESPACE, "Input ").concat(base, "-input"), errorMessage && 'is-error', hasFloatingLabel && value && 'has-value');
      var elementStyles = autogrow ? (0, _objectSpread2.default)({}, rest.style, {
        overflow: 'hidden'
      }) : rest.style;
