  ...
  (0, _createClass2.default)(List, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["children", "className", "ordered", "definition"]);
      var base = "".concat(_constants.OLT_NAMESPACE, "List");
      return _react.default.createElement("ul", (0, _extends2.default)({}, props, {
        className: (0, _classnames.default)(base, ordered && "".concat(base, "--ordered"), definition && "".concat(base, "--definition"), className)
      }), children);
    }
  }]);
  return List;
