...
export class Dropdown extends Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleOffClick", event => {
      ...
      const isContained = 'contains' in dropdown ? dropdown.contains(event.target) : event.target;
  ...
  render() {
    const _this$props = this.props,
      ...
      disabled
          ...
          props = _objectWithoutProperties(_this$props, ["children", "className", "label", "color", "outline", "disabled"]);
    ...
    return React.createElement("div", _extends({
      ...
      className: classnames(base, color && `${base}--${color}`, outline && `${base}--outline`, className, open && `is-open`, disabled && `is-disabled`)
