  ...
  (0, _createClass2.default)(SelectField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "".concat(_constants.OLT_NAMESPACE, "SelectField ").concat(styles.selectField)
      }, label && _react.default.createElement(_Label.Label, null, label, required && !readOnly ? '*' : null), _react.default.createElement(_Select.Select, (0, _extends2.default)({
        fullwidth: fullwidth,
        disabled: disabled,
        ...
        className: "".concat(styles.message, " ").concat(_constants.OLT_NAMESPACE, "u-textError")
      }, errorMessage)));
    }
  }]);
  return SelectField;
