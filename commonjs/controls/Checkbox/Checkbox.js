...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(Checkbox, [{
    ...
    value: function render() {
      ...
      var label = children && _react.default.createElement("label", {
        htmlFor: "checkbox1",
        className: "label ".concat(_constants.OLT_NAMESPACE, "Checkbox-label ").concat(_constants.OLT_NAMESPACE, "u-fontSizeSmall ").concat(_constants.OLT_NAMESPACE, "u-marginBottom1")
      }, children);
