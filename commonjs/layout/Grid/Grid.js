  ...
  (function(_PureComponent) {
    ...
    function Grid() {
      ...
      return (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(Grid).apply(this, arguments),
      );
    }
    ...
    (0, _createClass2.default)(Grid, [
      {
        ...
        value: function render() {
          ...
          var classes = (0, _classnames.default)(
            ''.concat(_constants.OLT_NAMESPACE, 'Grid'),
            noPadding && ''.concat(_constants.OLT_NAMESPACE, 'Grid--noPadding'), // NOTE: What about --gutterless?
