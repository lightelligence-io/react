  ...
  (0, _createClass2.default)(Menu, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["children", "className", "color", "outline", "submenu", "navbar", "disabled", "items"]);
      var base = "".concat(_constants.OLT_NAMESPACE, "Menu");
      var navbarBase = "".concat(_constants.OLT_NAMESPACE, "Navbar");
      return _react.default.createElement("div", (0, _extends2.default)({}, props, {
        className: (0, _classnames.default)(base, color && "".concat(base, "--").concat(color), outline && "".concat(base, "--outline"), submenu && "".concat(base, "--sub"), disabled && 'is-disabled', navbar && "".concat(navbarBase, "-menu"))
      }), items.length > 0 ? items.map(function (_ref) {
        var label = _ref.label,
            itemProps = (0, _objectWithoutProperties2.default)(_ref, ["label"]);
        return _react.default.createElement(_MenuItem.MenuItem, (0, _extends2.default)({
          key: "".concat(label)
        }, itemProps), label);
      }) : children);
    }
