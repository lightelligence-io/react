...
function (_PureComponent) {
  ...
  function Table() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleRowClick", function (event) {
      var _this$props = _this.props,
          selectable = _this$props.selectable,
          onSelect = _this$props.onSelect,
          rows = _this$props.rows;
      var rowElement = event.target.closest('tr');
      var index = (0, _toConsumableArray2.default)(rowElement.parentNode.children).indexOf(rowElement);
      var row = rows[index];
      selectable && onSelect && onSelect(row);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "renderRow", function (row, rowIndex) {
      var children = _this.props.children;
      return _react.default.createElement("tr", {
        className: (0, _classnames.default)("".concat(_constants.OLT_NAMESPACE, "Table-row"), "".concat(_constants.OLT_NAMESPACE, "Table-row--selectable")),
        key: rowIndex,
  ...
  (0, _createClass2.default)(Table, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props2, ["header", "rows", "className", "selectable", "justify"]);
      ...
      return _react.default.createElement("div", {
        ...
        className: (0, _classnames.default)(base, selectable && "".concat(base, "--selectable"), justify && "".concat(base, "--justify"))
      }, props), header, _react.default.createElement("tbody", {
