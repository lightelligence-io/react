  ...
  (0, _createClass2.default)(ListItem, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["children", "className", "term"]);
      var base = "".concat(_constants.OLT_NAMESPACE, "List");
      return _react.default.createElement(_react.default.Fragment, null, term && _react.default.createElement("li", (0, _extends2.default)({}, props, {
        className: (0, _classnames.default)("".concat(base, "-term"), className)
      }), term), _react.default.createElement("li", (0, _extends2.default)({}, props, {
        className: (0, _classnames.default)("".concat(base, "-item"), className)
      }), children));
    }
  }]);
  return ListItem;
