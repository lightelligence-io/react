  ...
  (function(_PureComponent) {
    ...
    function Headline() {
      ...
      return (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(Headline).apply(this, arguments),
      );
    }
          ...
          return _react.default.createElement(
            ...
            (0, _extends2.default)({}, props, {
              className: (0, _classnames.default)(
                ''.concat(_constants.OLT_NAMESPACE, 'Headline'),
                ''.concat(_constants.OLT_NAMESPACE, 'Headline--').concat(size),
                regular &&
                  ''.concat(_constants.OLT_NAMESPACE, 'Headline--regular'),
                color &&
                  ''
                    .concat(_constants.OLT_NAMESPACE, 'u-text')
                    .concat((0, _humps.pascalize)(color)),
                className,
              ),
            }),
            children,
