          ...
          return _react.default.createElement(
            ...
            (0, _extends2.default)({}, props, {
              className: (0, _classnames.default)(
                base,
                size === _constants.AVATAR_SIZE_LARGE &&
                  ''.concat(base, '--large'),
                type === 'tenant'
                  ? ''.concat(base, '--tenant')
                  : ''.concat(base, '--user'),
...
(0, _defineProperty2.default)(Avatar, 'propTypes', {
  ...
  size: (0, _propTypes.oneOf)([
    _constants.AVATAR_SIZE_MEDIUM,
    _constants.AVATAR_SIZE_LARGE,
  ]),
  type: (0, _propTypes.oneOf)([
    _constants.AVATAR_TYPE_USER,
    _constants.AVATAR_TYPE_TENANT,
  ]).isRequired,
});
