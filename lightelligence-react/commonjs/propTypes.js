...
var childrenProp = (0, _propTypes.oneOfType)([
  (0, _propTypes.arrayOf)(_propTypes.node),
  _propTypes.node,
]);
exports.childrenProp = childrenProp;
var colorProp = (0, _propTypes.oneOf)([
...
var headlineTypeProp = (0, _propTypes.oneOf)([
...
var copyTextTypeProp = (0, _propTypes.oneOf)([
  constants.ELEMENT_P,
  constants.ELEMENT_SPAN,
]);
exports.copyTextTypeProp = copyTextTypeProp;
var copyTextSizeProp = (0, _propTypes.oneOf)([
